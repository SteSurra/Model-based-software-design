...
typedef struct {
  ...
  uint8_T is_active_c2_feedback_control;/* '<S4>/TriggerPulseGenerator' */
  uint8_T is_c2_feedback_control;      /* '<S4>/TriggerPulseGenerator' */
  uint8_T is_active_c5_feedback_control;/* '<S3>/FromEchoToDistance' */
  uint8_T is_COMPUTE_ECHO_DURATION;    /* '<S3>/FromEchoToDistance' */
  uint8_T is_active_c1_feedback_control;/* '<S2>/MonitoringLogic' */
  uint8_T is_c1_feedback_control;      /* '<S2>/MonitoringLogic' */
  uint8_T is_active_c3_feedback_control;/* '<S1>/Blink' */
  uint8_T is_c3_feedback_control;      /* '<S1>/Blink' */

 ...
 * C/C++ source code generated on : Fri Jun 25 07:14:26 2021
 *
  ...
  boolean_T *feedback_control_Y_Error, boolean_T *feedback_control_Y_Trigger)
{
  ...
  if (feedback_control_DWork->is_active_c3_feedback_control == 0U) {
    ...
    /* Transition: '<S6>:4' */
    feedback_control_DWork->is_c3_feedback_control = feedback_control_IN_RESET;
  ...
  if (feedback_control_DWork->is_active_c5_feedback_control == 0U) {
    ...
    /* Transition: '<S8>:2' */
    feedback_control_DWork->is_c5_feedback_control = feedback_control_IN_HIGH;
    feedback_control_DWork->temporalCounter_i1 = 0U;

    /* Outport: '<Root>/Trigger' */
    /* Entry 'HIGH': '<S8>:1' */
    *feedback_control_Y_Trigger = true;
  } else if (feedback_control_DWork->is_c5_feedback_control ==
    ...
    *feedback_control_Y_Trigger = true;
    ...
    if (feedback_control_DWork->temporalCounter_i1 >= 20U) {
      /* Transition: '<S8>:5' */
      feedback_control_DWork->is_c5_feedback_control = feedback_control_IN_LOW;
      feedback_control_DWork->temporalCounter_i1 = 0U;
  ...
  *feedback_control_Y_Trigger)
{
  ...
  *feedback_control_U_Echo = 0.0;
...

  {
    ...
    feedback_control_DWork->is_c5_feedback_control =
      feedback_con_IN_NO_ACTIVE_CHILD;

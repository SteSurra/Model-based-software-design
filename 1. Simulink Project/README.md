...
"distance * 58" and it represents the duration of the Echo signal expressed in usec.
...
It follows that as soon as the Echo value goes low, the count value will be equal to Echo pulse duration expressed in usec. At this point the distance in cm is obtained using the formula "distance = counter / 58".
